...
from multiagent_particle_env.alternate_policies import delaunay_triangulation_prey_fixed
...
class Scenario(BaseScenario):
    ...
    def make_world(self, args):
        ...
        for i, agent in enumerate(world.agents):
            ...
            if agent.adversary:
                agent.action_callback = distance_minimizing_fixed_strategy
                agent.is_fixed_policy = True
            else:
                agent.action_callback = delaunay_triangulation_prey_fixed
                agent.is_fixed_policy = True
